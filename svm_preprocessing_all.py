...
X_train_df.to_csv('SVM_all_X_train.csv', index=False)

y_train_df = pd.DataFrame(y_train)
y_train_df.to_csv('SVM_all_y_train.csv', index=False)

X_test_df = pd.DataFrame(X_test)
X_test_df.to_csv('SVM_all_X_test.csv', index=False)

y_test_df = pd.DataFrame(y_test)
y_test_df.to_csv('SVM_all_y_test.csv', index=False)
